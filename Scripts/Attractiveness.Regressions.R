###############################################################################
## Replication script for tables using Attractiveness as predictor
...
stargazer(models,
          ...
          #out = paste0(result_path, "test.html"),
...
stargazer(models,
          type = "latex",
          #title = paste0(election, ": Linear Regression Results For ", trait),
          style = "apsr",
